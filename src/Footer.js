          ...
          <div className="u-align-center u-container-style u-expanded-width-sm u-expanded-width-xs u-group u-group-1">
            <div className="u-container-layout u-valign-middle-md">
              ...
              {/* <div className="u-align-left u-social-icons u-spacing-10 u-social-icons-1"> */}
                <a target="_blank" href="https://facebook.com/AlexisGado">
                <FontAwesomeIcon icon={faFacebookSquare} size='3x' style={{margin:"2%"}}/>
                </a>
                <a target="_blank" href="https://www.github.com/mistergado">
                <FontAwesomeIcon icon={faGithubSquare} size='3x' style={{margin:"2%"}}/>
                </a>
                <a target="_blank" href="https://linkedin.com/in/alexis-gadonneix-a20088159/">
                <FontAwesomeIcon icon={faLinkedin} size='3x' style={{margin:"2%"}}/>
                </a>
